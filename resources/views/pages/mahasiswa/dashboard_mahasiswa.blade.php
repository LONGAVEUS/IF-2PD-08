    ...
    <div class="grid grid-cols-3 gap-2 md:gap-6">
        <div class="bg-white border-2 border-indigo-50 rounded-xl md:rounded-2xl p-3 md:p-6 shadow-sm">
            <div class="w-7 h-7 md:w-10 md:h-10 rounded-lg bg-indigo-50 flex items-center justify-center mb-2 md:mb-3">
                <svg class="w-4 h-4 md:w-5 md:h-5 text-indigo-600" fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24">
        ...
        <div class="bg-white border-2 border-indigo-50 rounded-xl md:rounded-2xl p-3 md:p-6 shadow-sm">
            <div class="w-7 h-7 md:w-10 md:h-10 rounded-lg bg-blue-50 flex items-center justify-center mb-2 md:mb-3">
                <svg class="w-4 h-4 md:w-5 md:h-5 text-blue-500" fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24">
        ...
        <div class="bg-white border-2 border-indigo-50 rounded-xl md:rounded-2xl p-3 md:p-6 shadow-sm">
            <div class="w-7 h-7 md:w-10 md:h-10 rounded-lg bg-violet-50 flex items-center justify-center mb-2 md:mb-3">
                <svg class="w-4 h-4 md:w-5 md:h-5 text-violet-500" fill="none" stroke="currentColor" stroke-width="2"
                    viewBox="0 0 24 24">
