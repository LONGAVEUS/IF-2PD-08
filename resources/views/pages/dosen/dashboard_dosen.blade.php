    ...
    <div class="bg-white/80 backdrop-blur rounded-3xl shadow-xl border border-indigo-100 p-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div class="bg-white border border-indigo-100 rounded-2xl p-5 shadow-sm">
                ...
                <span class="mt-2 inline-block text-xs bg-indigo-50 text-indigo-600 px-2 py-0.5 rounded-full">semester
                    ini</span>
            </div>
            ...
            <div class="bg-white border border-blue-100 rounded-2xl p-5 shadow-sm">
                ...
                <span class="mt-2 inline-block text-xs bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full">semua
                    kelas</span>
            </div>
            ...
            <div class="bg-white border border-green-100 rounded-2xl p-5 shadow-sm">
                ...
                <span class="mt-2 inline-block text-xs bg-green-50 text-green-600 px-2 py-0.5 rounded-full">matkul
                    selesai</span>
            </div>
            ...
            <div class="bg-white border border-red-100 rounded-2xl p-5 shadow-sm">
                ...
                <span class="mt-2 inline-block text-xs bg-red-50 text-red-500 px-2 py-0.5 rounded-full">segera
                    selesaikan</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="divide-y divide-gray-50">
                ...
                <div class="flex items-center gap-4 px-6 py-4">
                    <div
                        class="w-7 h-7 rounded-lg bg-indigo-50 text-indigo-600 flex items-center justify-center text-xs font-semibold">
                        {{ $index + 1 }}
                    </div>
