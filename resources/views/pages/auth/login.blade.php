...
<section class="min-h-screen bg-center bg-no-repeat bg-cover bg-gray-600 bg-blend-multiply"
    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <a href="#"
            class="flex items-center mb-6 text-4xl font-bold text-white drop-shadow-lg tracking-wide text-center">
            PENGISIAN KRS & KHS
        </a>
        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('login.post') }}" method="POST">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center">
                        Sign in
                    </button>
                </form>
            </div>
