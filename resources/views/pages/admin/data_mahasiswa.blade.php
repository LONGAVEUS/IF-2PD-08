...
<div class="space-y-6">
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-7">
                            <div>
                                ...
                                <select name="semester_ke" required
                                    ...
                                    <option value="1" {{ $m->mahasiswa->semester_ke == 1 ? 'selected' : '' }}>Semester 1
                                    </option>
    ...
    <x-modal id="modalTambah" title="Tambah Mahasiswa">
        <form action="{{ route('mahasiswa.store') }}" method="POST" class="p-0.5">
            ...
            <div class="mb-5">
                <label class="block mb-1.5 text-[11px] font-bold text-gray-600 uppercase tracking-wider">Program
                    Studi:</label>
                <select name="prodi" required
            ...
            <div class="mb-5">
                <label class="block mb-1.5 text-[11px] font-bold text-gray-600 uppercase tracking-wider">Password
                    Login:</label>
