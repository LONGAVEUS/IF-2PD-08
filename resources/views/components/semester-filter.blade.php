...
<div class="flex flex-row items-center gap-3 w-full md:w-auto">
    ...
    <select name="semester" onchange="this.form.submit()"
        class="flex-1 md:flex-none bg-white border-2 border-indigo-50 text-gray-900 text-sm rounded-xl focus:ring-indigo-500
         focus:border-indigo-500 block p-2.5 outline-none font-bold cursor-pointer">
